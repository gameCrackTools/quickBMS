...
int perform_compression(u8 *in, int zsize, u8 **ret_out, int size, int *outsize, u_int offset_info) {
    ...
    switch(g_compression_type) {
        ...
        QUICK_COMP_CASE(PPMDH_RAW)
            ...
            break;
        QUICK_COMP_CASE(RNC) size = _rnc_unpack(in, zsize, out, 0); break;
        ...
        QUICK_COMP_CASE(LBALZSS1) size = lbalzss(in, zsize, out, size, 1); break;
        QUICK_COMP_CASE(LBALZSS2) size = lbalzss(in, zsize, out, size, 2); break;
        ...
        */
        ...
        QUICK_COMP_CASE(LZO2A_COMPRESS) QUICK_COMP_COMPRESS_DEFAULT(0); size = lzo_compress(in, zsize, out, size, g_compression_type); break;
        ...
        QUICK_COMP_CASE(RNC_COMPRESS) // QUICK_COMP_COMPRESS_DEFAULT(0);
            ...
            break;
        QUICK_COMP_CASE(LZ4_COMPRESS) QUICK_COMP_COMPRESS_DEFAULT(0); size = LZ4_compressHC2_limitedOutput(in, out, zsize, size, 16); break;
        ...
        QUICK_COMP_CASE(BPE_COMPRESS) QUICK_COMP_COMPRESS_DEFAULT(0); size = bpe_compress(in, zsize, out, size); break;
